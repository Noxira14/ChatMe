		...
		_users_child_listener = new ChildEventListener() {
			...
			public void onChildAdded(DataSnapshot _param1, String _param2) {
				...
				if (key.equals(_childKey)) {
					...
					members.setText("Group • ".concat("Members data not found!"));
					if (_childValue.containsKey("admin")) {
						if (FirebaseAuth.getInstance().getCurrentUser().getUid().equals(_childValue.get("admin").toString())) {
							admin.setText("Admin • ".concat(" You"));
						} else {
							seacrhT = _childValue.get("admin").toString();
							if (_childKey.equals(seacrhT)) {
								adminName = _childValue.get("username").toString();
								admin.setText("Admin • ".concat(adminName));
							} else {
								admin.setText("Admin • ".concat(seacrhT));
							}
						}
					}
				}
